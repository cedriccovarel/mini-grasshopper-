...
document.getElementById('addBoxBtn').onclick = () => createNode({ kind: 'box', x: 180 - currentProject().panX / currentProject().scale, y: 130 - currentProject().panY / currentProject().scale });
document.getElementById('addPanelBtn').onclick = () => createNode({ kind: 'panel', x: 180 - currentProject().panX / currentProject().scale, y: 130 - currentProject().panY / currentProject().scale });
document.getElementById('addSliderBtn').onclick = () => createNode({ kind: 'slider', x: 180 - currentProject().panX / currentProject().scale, y: 130 - currentProject().panY / currentProject().scale });
document.getElementById('addSwitchBtn').onclick = () => createNode({ kind: 'switch', x: 180 - currentProject().panX / currentProject().scale, y: 130 - currentProject().panY / currentProject().scale });
